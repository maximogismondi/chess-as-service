...
juego.agregar_pieza([4, 4], new Reina(1, 0));
...
document.getElementById("crear_pieza").addEventListener("click", function () {
  ...
  switch (pieza) {
    case "rey":
      juego.agregar_pieza(
        [fila, columna],
        new Rey(color == "negro" ? 0 : 1, 0)
      );
      break;
    case "reina":
      juego.agregar_pieza(
        [fila, columna],
        new Reina(color == "negro" ? 0 : 1, 0)
      );
      break;
    case "torre":
      juego.agregar_pieza(
        [fila, columna],
        new Torre(color == "negro" ? 0 : 1, 0)
      );
      break;
    case "alfil":
      juego.agregar_pieza(
        [fila, columna],
        new Alfil(color == "negro" ? 0 : 1, 0)
      );
      break;
    case "caballo":
      juego.agregar_pieza(
        [fila, columna],
        new Caballo(color == "negro" ? 0 : 1, 0)
      );
      break;
    case "peon":
      juego.agregar_pieza(
        [fila, columna],
        new Peon(color == "negro" ? 0 : 1, 0)
      );
      break;
  }
...
function mostrar_pieza(posicion) {
  ...
  console.log(casillero.obtener_contenido().color);
  if (casillero.obtener_contenido().color == 0) {
    source += "b";
  } else {
    source += "w";
  }
